...
root_folder = r'C:\Users\va648\PycharmProjects\ScibowlScrim-Backend\External Packets\SBST'

pdf_paths = get_pdf_paths(root_folder)
#pdf_paths = [pdf_paths[0]]
csv_file_path = r'C:\Users\va648\PycharmProjects\ScibowlScrim-Backend\csvs\sbst.csv'
...
for file in pdf_paths:
    ...
    try:
        ...
        keys_to_delete = [key for key, value in question_dict.items() if 'VISUAL' in value['category'] or 'VISUAL' in value['tossup_question'] or
                          'VISUAL' in value['tossup_answer'] or 'VISUAL' in value['bonus_question'] or value['category'] == '']
        ...
        for key in question_dict.keys():
            ...
            if values[0] != '':
                with open(r'C:\Users\va648\PycharmProjects\ScibowlScrim-Backend\csvs\sbst.csv', 'a', newline='', encoding='utf-8') as csvfile:
